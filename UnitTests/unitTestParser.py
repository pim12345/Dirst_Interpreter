...
class TestParserDATSubset(unittest.TestCase):
    def test_abs(self):
...
class TestParserTXTSubset(unittest.TestCase):
    def test_rdc(self):
...
class TestParserBINSubset(unittest.TestCase):
...
class TestParserZIPSubset(unittest.TestCase):
...
class TestParserEXESubset(unittest.TestCase):
...
class TestParserDLLSubset(unittest.TestCase):
...
class TestParserCSVSubset(unittest.TestCase):
...
class TestParserLNKSubset(unittest.TestCase):#LNK class is added for the atp course
